...
import { getAllCarts, removeFromCart, toggleCartQty, clearCart, getCartTotal, setCartMessageOn, getCartMessageStatus } from "../../store/cartSlice";
import CheckOutMessage from "../../components/CartMessage/CheckOutMessage";
...
const CartPage = () => {
  ...
  const addToCartHandler = async () => {
    await checkOut({ arrOrder: carts, userInfo: newauth });
  ...
  return (
    <main>
          ...
          <div className="cart-ctable">
              ...
              {carts.map((cart, idx) => {
                return (
                  <div className="cart-ctr py-4" key={cart?.id}>
                    ...
                    <div className="cart-ctd">
                      <span className="cart-ctxt">{cart?.discountedPrice}</span>
                    </div>
                    <div className="cart-ctd">
            ...
            <div className="cart-cfoot flex align-start justify-between py-3 bg-white">
              ...
              <div className="cart-cfoot-r flex flex-column justify-end">
                ...
                <button type="button" className="checkout-btn text-white bg-orange fs-16" onClick={addToCartHandler}>
                  Check Out
                </button>
              </div>
            </div>
      ...
      {cartMessageStatus && <CheckOutMessage />}
    </main>
  );
};
