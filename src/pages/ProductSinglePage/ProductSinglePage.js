...
const ProductSinglePage = () => {
  ...
  let discountedPrice = product?.productIdSale.pricesale;
              ...
              <div className="product-details font-manrope">
                ...
                <div className="info flex align-center flex-wrap fs-14">
                  ...
                  <div className="brand">
                    ...
                    <span className="mx-1">{product?.brandIdData.name}</span>
                  </div>
                  <div className="vert-line"></div>
                  <div className="brand">
                    <span className="text-orange fw-5">Category:</span>
                    <span className="mx-1 text-capitalize">{product?.CategoryIdData ? product?.CategoryIdData.name : ""}</span>
                  </div>
                </div>
